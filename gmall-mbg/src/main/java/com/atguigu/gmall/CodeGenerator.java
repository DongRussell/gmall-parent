...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\JavaEE\\gmall-parent\\gmall-mbg" + "/src/main/java");
        gc.setAuthor("Brodie");
        ...
        dsc.setUrl("jdbc:mysql://192.168.81.149:3306/gmall_"+moduleName+"?useUnicode=true&useSSL=false&characterEncoding=utf8");
